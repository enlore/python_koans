...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # reduce pops items of the list and plugs them into the accumulator function
        # so you build a new value using the operation in the function and all the 
        # values in the list, resulting in a cumulativly generated value and no
        # more list
